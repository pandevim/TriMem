...
\begin{itemize}
    \item \textbf{Low Entropy ($< 0.3$):} High confidence. The agent relies on internal MSA/context to execute actions.
    \item \textbf{Medium Entropy ($0.3 - 0.7$):} Environmental uncertainty. The router injects Visual Bus patches to update episodic beliefs.
